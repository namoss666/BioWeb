...
function App() {
  ...
  // Typewriter effect
  const [bioText, setBioText] = useState("Owner of Nyrox.site");
  ...
  return (
    <div className='app-container'>
      ...
      <div className={`main-container ${entered ? 'entered' : ''}`}>
        ...
        <div className='info' >
          <h1 className='name'>Namoss</h1>
          <h1 className='bio'>{bio}</h1> {/* Bio with typewriter effect */}
        </div>
        <div className='links'>
          <a href="https://www.youtube.com/@Namoss999" target="_blank" rel="noopener noreferrer">
            <img src={yt} className='link4' alt="YouTube" />
          </a>
          <a href="https://discord.com/users/1269323379991773214" target="_blank" rel="noopener noreferrer">
        ...
        <button
          className='button2'
          onClick={() => handleCopyAddress1('La2nyMLurhjSjU1c7Abd3wLGsZGC7X4AF4', 'LTC Address')}
        ...
        <button
          className='button1'
          onClick={() => handleCopyAddress('bc1qtnt0jl38hjc990985fhfm2x5ft8k9a938ufgf0', 'BTC Address')}
          data-label={cssLabel}
        >
          BTC
        </button>
